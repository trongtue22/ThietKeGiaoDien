...
//  If the user have click the buttton GO  
if(isset($_POST['Go']))
{
    $result = Search_Data(); 
}
else // If the user don't click the button GO => This is a default situation when they open up the Tab
{
  $result = display();
}
...
<head>
    ...
    <title>Giới thiệu trang web tìm việc</title>
...
<body>
    <nav class="navbar navbar-expand-md bg-secondary">
        <div class="col-xl-5 col-xxl-3 col-md-3 col-md-6" id="search-container" style="margin-left: 5%;">
            <a href="#">
                <img class="botron" src="img/logo.png">
            </a>
        </div>
        <div class="container-fluid"><a class="navbar-brand" href="#">Home</a><button data-bs-toggle="collapse"
    ...
    <!-- Thanh search => Phải có cách ở đây để lấy data mà người dùng nhập vào -->
    <div class="container py-4 py-xl-5">
        <div class="d-flex justify-content-center mt-3">
                <form action="" method="POST" class="input-group mb-2 text-center" style="max-width: 300px;">
        ...
        <ul class="nav nav-tabs">
            <!-- <li class="nav-item"><a class="nav-link" href="#">Quan Hệ Truyền Thông và Công Chúng</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><span
                        style="color: var(--white); background-color: transparent;">Khoa Điều dưỡng &amp; Kỹ thuật y
                        học</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#"><span
                        style="color: var(--white); background-color: transparent;">Khoa Du lịch</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#"><span
                        style="color: var(--white); background-color: transparent;">Khoa Dược</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#">Kiến Trúc</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><span
                        style="color: var(--white); background-color: transparent;">Khoa Mỹ thuật &amp; Thiết
                        kế</span></a></li>
            <li class="nav-item"><a class="nav-link" href="#">Ngành Đồ Hoạ</a></li> -->
            <!-- <h3 style="text-align: center;">Giới thiệu trang web tìm việc</h3>  -->
        </ul>
        <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                        <!--  This is where the data go to -->
            <?php 
                // Take this $result as a target:   
            ...
            <div class="col">
                <div class="card">
                        ...
                        <a href="<?php echo $row['link']; ?>" target="_blank">
                            ...
                            src="../Upload/<?php echo $row['picture']; ?>" width="100" height="100">
                        </a>
                    
                        <div class="card-body p-4">
                        <h4 class="card-title"><?php echo $row['name']  ?> </h4>
                        <span class="cart-text"><?php echo $row['description']  ?></span><br>
                        <!-- <span class="cart-text">Vị trí :</span> -->
                        <!-- <p class="card-text">Mô tả công ty</p>   -->
                    </div>
                </div>
            </div>
            <?php 
            ...
            <!-- <div class="col">
                <div class="card"><img class="card-img-top w-100 d-block fit-cover" style="height: 200px;"
                    ...
                    <div class="card-body p-4">
                        <h4 class="card-title">ông tý a</h4>
                        <span class="cart-text">Địa chỉ :</span><br>
                        <span class="cart-text">Vị trí :</span>
                        <p class="card-text">Mô tả công ty</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="fw-bold d-flex align-items-center mb-2"><span
                            class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2"><svg
                                ...
                                viewBox="0 0 16 16" class="bi bi-bezier fs-5">
