            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="page-login account-box-shadow">
                    <div id="login">
                        ...
                        <div class="text-center fix-sblock"></div>
                            ...
                            <div class="form-signup clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center" style="margin-top: 30px; margin-bottom:30px;">
                                        <a href="index.html" title="Đăng nhập" class="btn btn-register btn-register-login" style="background-color: green; color: white;">
                                            Đăng nhập
                                        </a>
                                    </div>
                                </div>
