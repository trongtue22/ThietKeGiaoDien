...
// The if code here don't work
if(isset($_POST['signin_button']))
{
    // Check the validation form to see all the conditon true or false 
        ...
        <div class="row" style="justify-content: center">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="page-login account-box-shadow">
                    <div id="login">
                        <h1 class="title-head text-center">Đăng nhập tài khoản</h1>
                        <div class="text-center fix-sblock">Nếu chưa có tài khoản vui lòng đăng ký tại đây</div>
                        <!--  Here is the form  -->
                        <form method="post" action="" id="customer_register" accept-charset="UTF-8" class="has-validation-callback">
                            <input name="FormType" type="hidden"
                                value="customer_register">
                                <input name="utf8" type="hidden" value="true">
                                <input
                                type="hidden" id="Token-9cf1d452008740309bb98474698cf2f3" name="Token"
                                value="03AL8dmw8rv6g3ODFc2MY03a7YvBMjctX2VOWqQJuobSRDq8tI-VP0p3EPdbJ_zWKcAq6ogUIPK1XpOBwgduy3xGsba-b88H2Zx0FbyYLR2enNJTFtP3I--79Sb2Q_jSnXbeySukYcn6U5ZJxo3oJReiXIEWcJ3RzBTktxvucV6NnegSkllYz3DwF4KUCk7fYNayZJf854wB11tBvnHN_aOCWeMpwYUh9WO6mPW-XJDe6gYDH3Z_Nyt43XV7duXqVVu9UrjgDCosOryAPFfEqMdGUJITDT_Jx0h9lUsEXGx6g4t6e-7i6sKy4CveQXdvOsZXI2BDhkkmgTh4Zif8Eojd_jkGxgvzbH79gaflgWkIxkisR-UNLkeewbs2z-teyhz1-gpnCKFKF2kPd_4BmlR47lbqG57pD-1GN-F9sVXna8K8BPOUr-BxssTUc6sIS3ZDgeBtBbRPUMKRtA29BLccKnGzr-E8kQ368L08sA_bkmQAjApahFVEhLMgxwFmelaA_hLG8B5enYbACQelZE8l_Ia0hrpoVQibY_LX2ntPBFofUkOB2D5cI">
                            ...
                            <div class="form-signup clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="form-group">
                                            ...
                                            <input placeholder="Nhập Tên" type="text"
                                                class="form-control form-control-lg" value="" name="firstName"
                                    ...
                                    <div class="col-md-12 text-center" style="margin-top: 30px; margin-bottom:30px;">
                                        <button name='signin_button' title="Đăng nhập" class="btn btn-register btn-register-login btn-success">
                                                    Tạo tài khoản
                                        </button>
                                    </div>
                                <
